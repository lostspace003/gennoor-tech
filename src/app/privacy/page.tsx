...
export const metadata: Metadata = {
  ...
  description:
    'Our privacy policy is being finalized. We are committed to protecting your data and will publish our complete privacy policy shortly.',
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
      <div className="text-center max-w-2xl mx-auto px-4 py-24">
        ...
        <p className="text-lg text-gray-600 mb-10">
          Our privacy policy is being finalized. We are committed to protecting
          your data and will publish our complete privacy policy shortly.
        </p>
        <Link
          href="/"
