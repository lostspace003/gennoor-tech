...
<p>Technology-assisted review (TAR) and predictive coding — areas of active research at <a href="https://law.stanford.edu/codex-the-stanford-center-for-legal-informatics/" target="_blank" rel="noopener">Stanford's CodeX Center for Legal Informatics</a> — use machine learning to classify documents by relevance, privilege, and responsiveness. The system learns from human reviewer decisions and applies those judgments across the entire document set. Courts have repeatedly upheld TAR as an acceptable — and in many cases superior — alternative to manual review.</p>
...
<p>Legal AI carries unique risks that demand careful management. The most discussed risk is hallucination — AI generating plausible but incorrect information. In legal practice, hallucination is not just embarrassing; it can be malpractice. The widely reported case of a lawyer citing non-existent cases generated by ChatGPT was a wake-up call for the profession, and the <a href="https://www.americanbar.org/groups/professional_responsibility/publications/formal_ethics_opinions/" target="_blank" rel="noopener">American Bar Association's Formal Opinions on generative AI</a> now provide explicit professional-responsibility guidance.</p>
