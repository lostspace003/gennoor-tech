...
export const post: BlogPost = {
    ...
    content: `
<p>Every enterprise AI leader faces the same tension: legal wants controls, business wants speed, IT wants standardization. The frameworks that succeed create a structured path that satisfies all three — and align with external scaffolding like the <a href="https://www.nist.gov/itl/ai-risk-management-framework" target="_blank" rel="noopener">NIST AI Risk Management Framework</a> and the <a href="https://artificialintelligenceact.eu/high-level-summary/" target="_blank" rel="noopener">EU AI Act</a>.</p>
...
<li><strong>Red Zone (Regulated)</strong> — AI affecting hiring, credit, medical, or legally regulated decisions (the same use cases <a href="https://artificialintelligenceact.eu/article/6/" target="_blank" rel="noopener">EU AI Act Article 6</a> classifies as high-risk). Full compliance review, bias testing, executive sign-off.</li>
</ul>
