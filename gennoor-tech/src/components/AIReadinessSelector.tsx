...
import { Zap, Sparkles, ArrowLeft, Shield, Lock } from 'lucide-react'
...
type AssessmentMode = 'quick' | 'deep' | null
  ...
  if (selectedMode) {
    return (
      <div className="animate-fade-in">
        ...
        {selectedMode === 'quick' ? <AIReadinessQuiz /> : <AIReadinessQuizV2 />}
      </div>
    )
  }
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 max-w-5xl mx-auto">
        ...
        {/* Custom Blueprint Card — Locked */}
        <div className="group relative flex flex-col items-start rounded-2xl bg-gray-50 border border-gray-200 p-7 sm:p-8 text-left opacity-75 cursor-not-allowed">
          <div className="absolute top-4 right-4">
            <span className="inline-flex items-center gap-1 text-[10px] font-bold text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full uppercase tracking-wide">
          ...
          <div className="flex flex-col items-start w-full">
            <div className="flex items-center justify-between w-full mb-5">
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gray-100 text-gray-400">
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Full diagnostic with tailored AI implementation roadmap, team readiness matrix, and executive-ready PDF report.
            </p>
          </div>
        </div>
      </div>
      ...
      <p className="mt-8 sm:mt-10 text-center text-xs sm:text-sm text-gray-400 flex items-center justify-center gap-1.5">
        ...
        Both assessments are free. Your report is private.
      </p>
    </div>
  )
}
