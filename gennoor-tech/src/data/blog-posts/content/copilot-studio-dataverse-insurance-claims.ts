...
<li><strong>Power Automate</strong> — The integration glue. Cloud flows connect the agent to external systems: email notifications, payment systems, external databases, and third-party services.</li>
</ul>
