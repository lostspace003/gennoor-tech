...
export const post: BlogPost = {
    ...
    content: `
<p>The technology is ready. The UX often is not. <a href="https://www.gartner.com/en/insights/customer-service-and-support" target="_blank" rel="noopener">Gartner customer experience research</a> reports that 54% of chatbot deployments fail to meet user satisfaction targets, and the primary reason is not AI capability — it is poor conversational design. Users abandon chatbots not because the AI is bad, but because the experience is bad. They encounter dead ends, frustrating loops, robotic responses, and an inability to accomplish the task they came for. The difference between a chatbot users tolerate and one they actually love comes down to design principles that have nothing to do with model size or training data.</p>
...
<p>These principles form the foundation of chatbot experiences that users genuinely enjoy using. They apply regardless of the underlying AI technology — whether you are building with <a href="https://platform.openai.com/docs/guides/prompt-engineering" target="_blank" rel="noopener">GPT</a>, <a href="https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview" target="_blank" rel="noopener">Claude</a>, an open-source model, or a simple rule-based system.</p>
