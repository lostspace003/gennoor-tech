...
emit({
  ...
  slides: [
    ...
    { type: 'content', eyebrow: 'Next up · Chapter 7', icon: '→', headlineHtml: 'Connecting forecast to S&amp;OP · <em>FVA + LLM narrative</em>',
      blocks: [{ atStep: 1, html: closeCard('END OF CHAPTER 6', 'Analog + early signal + planner judgement. <em>The hybrid wins where pure ML fails.</em>', '<strong>Next:</strong> SCC 2025 — only 38% connect ML forecast to exec S&OP. FVA + LLM narrative layer + the LokadTech hallucination case.') }] }
  ],
  cues: [
    { at: 0.0, slide: 1 },
    { at: 15.0, slide: 2 }, { at: 25.0, slide: 2, step: 1 },
...
emit({
  ...
  slides: [
    ...
    { type: 'content', eyebrow: 'The LokadTech case · 2025', icon: '!', iconRed: true, headlineHtml: 'LLM commentary attributed variance to <em>a promotion that wasn\'t run</em>',
      blocks: [{ atStep: 1, html: cardRed('LokadTech INDUSTRY BLOG · 2025', 'LLM-generated S&OP commentary attributed regional spike to a quarter-end promotion that was cancelled', ['Promotion was on planned calendar but cancelled. LLM didn\'t know.', '<strong>CFO read commentary. Asked head of supply chain. Embarrassing.</strong>'], 'Fix is the same as the legal-citation rule: quote or cut. Every specific claim in S&OP commentary either has a source the AI pulled from, or it gets cut from the executive deck.') }] },
    ...
    { type: 'content', eyebrow: 'The executive consensus · 4 layers', icon: '3', headlineHtml: 'AI + LLM narrative + planner judgement + <em>exec consensus</em>',
      blocks: [
        ...
        { atStep: 2, html: card('MONDAY MOVE', 'Pull last month\'s S&OP exec deck · trace 1 specific commentary claim back to a number', ['<strong>If you can\'t trace in 5 minutes — LokadTech failure mode is 1 cycle away. Fix quote-or-cut before the next deck.</strong>']) }
      ] },
...
${cell('TRIP-WIRE 3', 'No AI narrative without source check', '', 'The LokadTech rule. Quote or cut. <strong>Every specific claim traces to a number — or it\'s cut from the deck.</strong>', 'red')}
