...
${cell('WORKS', 'Reconciliation · narratives · routine accruals · JEs from source docs', '', '35–50% rec hours saved (BlackLine/Trintech). 50–70% time saved on MD&A (KPMG). 85–92% accuracy on routine accruals (Vic.ai/Trintech).', 'green')}
${cell('DOESN\'T WORK', 'Judgement accruals · litigation/restructuring · complex revrec', '', 'Anything where the answer depends on facts only humans know.', 'red')}
        ...
        { atStep: 2, html: cardRed('WSJ CFO JOURNAL · AUG 2025', 'Fortune 500 controller caught AI-generated MD&A referencing a contract clause that didn\'t exist', ['<strong>Close held 36 hours</strong> while it was investigated. The variance-narrative version of Mata v. Avianca.'], 'The failure mode that scares audit committees.') }
      ] },
...
emit({
  ...
  slides: [
    ...
    { type: 'content', eyebrow: 'The failure mode · WSJ CFO Journal Aug 2025', icon: '!', iconRed: true, headlineHtml: 'Confabulated contract clause · <em>close held 36 hours</em>',
      blocks: [{ atStep: 1, html: cardRed('WSJ CFO JOURNAL · AUG 2025', 'Fortune 500 controller caught AI revenue-recognition narrative referencing a clause that didn\'t exist', ['The AI confabulated a specific clause to justify a variance. <strong>Close held 36 hours.</strong>', 'This is the variance-narrative version of <strong>Mata v. Avianca.</strong>'], 'Quote-or-cut. If AI says "Q3 revenue grew due to strategic customer deal in week 8" — there must be a Salesforce record or contract reference. No source — cut the sentence.') }] },
...
${cell('STAGE 3', 'Controller adds qualitative', '', 'The "why" the AI cannot know — customer decision, operational issue, strategic context. <strong>Where controller still earns the fee.</strong>', 'green')}
    ...
    { type: 'content', eyebrow: 'The discipline · what separates careers', icon: '3', headlineHtml: 'Stage 2 discipline · <em>career-defining</em>',
      blocks: [
        { atStep: 1, html: card('THE DISCIPLINE', 'Controllers who validate every specific claim never ship the error', ['Controllers who trust the draft and forward — eventually ship a fabricated clause.', 'WSJ story: 36 hours of delay. External auditor flagged. Board meeting at risk. <strong>Controller who caught it kept their job. Associate who didn\'t — different conversation.</strong>']) },
